        ...
        <ul className="mt-5 [&>li]:leading-7 [&>li>a]:text-black hover:[&>li>a]:text-brand hover:[&>li>a]:underline">
          {filter.values.map((value) => (
              <li key={value.id}>
                <Link
                  to={createFilterUrl(
                    isVariantFilter ? 'v' : 'p', // 'v' for variant, 'p' for product property
                    filterKey, // e.g. 'color' or 'size'
                    value.input // the filter value
                  )}
        ...
        {product.featuredImage && (
          <div className='w-j25'>
            ...
            />
             ...
             <div className='absolute top-0 left-0 w-11 gap-y-j5 flex flex-wrap'>
           <img src="/image/super-sale_1.jpg" alt="" />
           <img src="/image/only-at-jerrys_1.jpg" alt="" />
           <img src="/image/sale_1.jpg" alt="" />
        </div>
        </Link>
          </div>
        )}
