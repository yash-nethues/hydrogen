...
function FeaturedCollections({ collections, title }) {
  ...
  return (
    <div className='container 2xl:container pt-20'>
      ...
      <div className="featured-collectionShop By Categoriesons-grid flex wrap gap-14">
      ...
      <div className='container 2xl:container pt-20'>
        {bannerWithContentImage.map((banner, index) => (
          <div key={index} className="category-link-content pt-10">
            <div className={`flex items-center gap-20 bg-gray-100 ${index % 2 !== 0 ? 'flex-row-reverse' : ''}`}>
              <div className="w-1/2 text-center">
                <h2 className='text-4xl text-blue font-bold leading-relaxed'>{banner.title}</h2>
